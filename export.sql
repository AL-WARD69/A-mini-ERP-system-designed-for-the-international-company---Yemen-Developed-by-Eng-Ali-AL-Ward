...
Insert into CAR (CAR_NO,CAR_MAKE,CAR_MODE,BANZEN,LOO_NO,IMG,NOTE,COLER,FDATE,LDATE,FKILO,LKILO,OIL) values (33,'»Ê—‘',2020,'10_· —','2092_2','[B@156b7c1','‰ŸÌ›… Ãœ«','«»Ì÷',to_date('31-MAY-20','DD-MON-RR'),to_date('04-MAY-30','DD-MON-RR'),500958,364392,'ÃÌœ');
Insert into CAR (CAR_NO,CAR_MAKE,CAR_MODE,BANZEN,LOO_NO,IMG,NOTE,COLER,FDATE,LDATE,FKILO,LKILO,OIL) values (20103,'TOYOTE',2000,'20_· —','2345_2','[B@9d963f','«·”Ì«—… ‰ŸÌ›…','«»Ì÷',to_date('09-MAR-20','DD-MON-RR'),to_date('09-MAR-21','DD-MON-RR'),112030,129837,'„ Ê”ÿ');
...
Insert into CAR (CAR_NO,CAR_MAKE,CAR_MODE,BANZEN,LOO_NO,IMG,NOTE,COLER,FDATE,LDATE,FKILO,LKILO,OIL) values (20115,'KIA',2017,'30_· —','7645','[B@1f31d15','ÌÊÃœ ›ÌÂ« ’œ„…','«Œ÷—',to_date('09-MAY-20','DD-MON-RR'),to_date('09-MAR-21','DD-MON-RR'),52442,666,'„ Ê”ÿ');
Insert into CAR (CAR_NO,CAR_MAKE,CAR_MODE,BANZEN,LOO_NO,IMG,NOTE,COLER,FDATE,LDATE,FKILO,LKILO,OIL) values (20100,'HONDEY',2015,'30_· —','543243_5','[B@1fa79c8','›Ì «·Ê—‘…','«”Êœ',to_date('29-JUN-20','DD-MON-RR'),to_date('09-MAR-22','DD-MON-RR'),27277,333333,'ÃÌœ');
...
Insert into CAR (CAR_NO,CAR_MAKE,CAR_MODE,BANZEN,LOO_NO,IMG,NOTE,COLER,FDATE,LDATE,FKILO,LKILO,OIL) values (20116,'”Ê“ÊﬂÌ',1999,'40-· —','30495\2','[B@1516070','»«’ ﬂ«—Ì ‰ŸÌ› Ãœ«','«»Ì÷',to_date('25-JUN-20','DD-MON-RR'),to_date('04-JUL-20','DD-MON-RR'),256989,257000,'„‰ ÂÌ');
